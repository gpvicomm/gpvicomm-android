package com.gpvicomm.payment.view;
...
import static com.gpvicomm.payment.model.Card.BRAND_RESOURCE_MAP;
import static com.gpvicomm.payment.view.CardInputListener.FocusField.FOCUS_CARD;
import static com.gpvicomm.payment.view.CardInputListener.FocusField.FOCUS_CARDHOLDERNAME;
import static com.gpvicomm.payment.view.CardInputListener.FocusField.FOCUS_CVC;
import static com.gpvicomm.payment.view.CardInputListener.FocusField.FOCUS_EXPIRY;
import static com.gpvicomm.payment.view.CardInputListener.FocusField.FOCUS_POSTAL;
...
public class CardMultilineWidget extends LinearLayout {
    ...
    private PaymentEditText mCvcEditText;
    private PaymentEditText mPostalCodeEditText;
    private PaymentEditText mCardHolderNameEditText;
    ...
    private PaymentEditText mFiscalNumberEditText;
    private PaymentEditText mNipEditText;
    ...
    @VisibleForTesting
    CardMultilineWidget(Context context, boolean shouldShowPostalCode, boolean shouldShowCardHolderName, boolean shouldShowScanCard, boolean shouldShowLogo) {
        super(context);
    ...
    void adjustViewForLogoAttribute() {

        int visibility = mShouldShowLogo ? View.VISIBLE : View.GONE;
    ...
    private void checkAttributeSet(AttributeSet attrs) {
        if (attrs != null) {
            ...
            try {
                ...
                mShouldShowLogo =
                        a.getBoolean(R.styleable.CardMultilineWidget_shouldShowLogo, true);
    ...
    private void initView(AttributeSet attrs) {
        ...
        mNipEditText = (PaymentEditText) findViewById(R.id.et_add_source_nip_ml);
        mFiscalNumberEditText = (PaymentEditText) findViewById(R.id.et_add_source_fiscal_number_ml);



        mExpiryDateEditText = (ExpiryDateEditText) findViewById(R.id.et_add_source_expiry_ml);
        mCvcEditText = (PaymentEditText) findViewById(R.id.et_add_source_cvc_ml);
        mPostalCodeEditText = (PaymentEditText) findViewById(R.id.et_add_source_postal_ml);
        mCardHolderNameEditText = (PaymentEditText) findViewById(R.id.et_add_source_cardholdername_ml);
        ...
        mCvcEditText.setAfterTextChangedListener(
                new PaymentEditText.AfterTextChangedListener() {
                    @Override
    ...
    private static class ErrorListener implements PaymentEditText.ErrorMessageListener {
