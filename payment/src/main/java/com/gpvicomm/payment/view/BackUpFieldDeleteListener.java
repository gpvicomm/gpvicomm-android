 ...
 * it will be acting.
 */
class BackUpFieldDeleteListener implements PaymentEditText.DeleteEmptyListener {

    private final PaymentEditText backUpTarget;

    BackUpFieldDeleteListener(PaymentEditText backUpTarget) {
