...
import com.gpvicomm.payment.R;
import com.gpvicomm.payment.util.CardUtils;
import com.gpvicomm.payment.util.PaymentTextUtils;
...
import static com.gpvicomm.payment.model.PaymentJsonUtils.optCountryCode;
import static com.gpvicomm.payment.model.PaymentJsonUtils.optCurrency;
import static com.gpvicomm.payment.model.PaymentJsonUtils.optInteger;
import static com.gpvicomm.payment.model.PaymentJsonUtils.optString;
import static com.gpvicomm.payment.model.PaymentJsonUtils.putIntegerIfNotNull;
import static com.gpvicomm.payment.model.PaymentJsonUtils.putStringIfNotNull;

/**
 * A model object representing a Card in the Android SDK.
 */
public class Card extends PaymentJsonModel implements PaymentSource {
    ...
    public Card(
            ...
            String currency,
            String id) {
        this.number = PaymentTextUtils.nullIfBlank(normalizeCardNumber(number));
        this.expiryMonth = expMonth;
        this.expiryYear = expYear;
        this.cvc = PaymentTextUtils.nullIfBlank(cvc);
        this.holderName = PaymentTextUtils.nullIfBlank(name);
        this.addressLine1 = PaymentTextUtils.nullIfBlank(addressLine1);
        this.addressLine2 = PaymentTextUtils.nullIfBlank(addressLine2);
        this.addressCity = PaymentTextUtils.nullIfBlank(addressCity);
        this.addressState = PaymentTextUtils.nullIfBlank(addressState);
        this.addressZip = PaymentTextUtils.nullIfBlank(addressZip);
        this.addressCountry = PaymentTextUtils.nullIfBlank(addressCountry);
        this.type = asCardBrand(type) == null ? getType() : type;
        this.last4 = PaymentTextUtils.nullIfBlank(last4) == null ? getLast4() : last4;
        this.fingerprint = PaymentTextUtils.nullIfBlank(fingerprint);
        this.funding = asFundingType(funding);
        this.country = PaymentTextUtils.nullIfBlank(country);
        this.currency = PaymentTextUtils.nullIfBlank(currency);
        this.id = PaymentTextUtils.nullIfBlank(id);
    }
    ...
    public boolean validateCVC() {
        if (PaymentTextUtils.isBlank(cvc)) {
            return false;
        }
    ...
    public String getLast4() {
        if (!PaymentTextUtils.isBlank(last4)) {
            return last4;
        }
    ...
    public String getType() {
        if (PaymentTextUtils.isBlank(type) && !PaymentTextUtils.isBlank(number)) {
    ...
    private Card(Builder builder) {
        this.number = PaymentTextUtils.nullIfBlank(normalizeCardNumber(builder.number));
        this.expiryMonth = builder.expMonth;
        this.expiryYear = builder.expYear;
        this.cvc = PaymentTextUtils.nullIfBlank(builder.cvc);
        this.holderName = PaymentTextUtils.nullIfBlank(builder.name);
        this.addressLine1 = PaymentTextUtils.nullIfBlank(builder.addressLine1);
        this.addressLine1Check = PaymentTextUtils.nullIfBlank(builder.addressLine1Check);
        this.addressLine2 = PaymentTextUtils.nullIfBlank(builder.addressLine2);
        this.addressCity = PaymentTextUtils.nullIfBlank(builder.addressCity);
        this.addressState = PaymentTextUtils.nullIfBlank(builder.addressState);
        this.addressZip = PaymentTextUtils.nullIfBlank(builder.addressZip);
        this.addressZipCheck = PaymentTextUtils.nullIfBlank(builder.addressZipCheck);
        this.addressCountry = PaymentTextUtils.nullIfBlank(builder.addressCountry);
        this.last4 = PaymentTextUtils.nullIfBlank(builder.last4) == null
                ? getLast4()
                : builder.last4;
        this.type = asCardBrand(builder.brand) == null
                ? getType()
                : builder.brand;
        this.fingerprint = PaymentTextUtils.nullIfBlank(builder.fingerprint);
        this.funding = asFundingType(builder.funding);
        this.country = PaymentTextUtils.nullIfBlank(builder.country);
        this.currency = PaymentTextUtils.nullIfBlank(builder.currency);
        this.customerId = PaymentTextUtils.nullIfBlank(builder.customer);
        this.cvcCheck = PaymentTextUtils.nullIfBlank(builder.cvcCheck);
        this.id = PaymentTextUtils.nullIfBlank(builder.id);
    }
